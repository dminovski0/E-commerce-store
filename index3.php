...
$selektiraj = "select slika from sliki2 where id_slika = 1 or id_slika = 90 or id_slika = 196 or id_slika = 321 or id_slika = 560 or id_slika = 664 or id_slika = 717 or id_slika = 1021 or id_slika = 1061 or id_slika = 1107 or id_slika = 1148 or id_slika = 1247 or id_slika = 1274";
...
echo '<a href="galerija' . ($j + 1) . '.php" style="text-decoration:none; "><figcaption class="tekst"><p><h3 style="color:darkblue; ">'.$ime_kola[$j].'</h3><h4 style="color:gold;" >'.$cena_kola[$j].'</h4></p>Галерија</a></figcaption></figure>';
}
echo "</div>";
