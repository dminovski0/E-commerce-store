...
echo '<a href="galerija' . ($j + 1) . '.php" style="text-decoration:none; "><figcaption class="tekst"><p><h3 style="color:darkblue; ">'.$ime_kola[$j].'</h3><h4 style="color:gold;" >'.$cena_kola[$j].'</h4></p>Галерија</a><h2><input id="kvantitet'.$j.'" type="number" /><p><button onclick="dodadi'.$j.'()">Додади</button></p></figcaption></figure>';
}
echo "</div>";
echo "<html><head></head><body><button onclick='dodadi()'>Додади</button></body></html>";
