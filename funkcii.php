...
$ime_na_tabela_sliki = "sliki";
$upit_sliki = "create table if not exists sliki (
...
primary key(id_slika)
	...
	for ($j = 1; $j < 1372; ++$j)
	{
$vnes_sliki = "insert into sliki(ime_slika, slika, tip_kola) values('a$j', load_file('D:/Wallpapers/$j.jpg'), 'Alpha Romeo')";
$rezultat2 = mysql_query($vnes_sliki) or die("Vnes greska: " . mysql_error());
}
$selektiraj = "select slika from sliki";
